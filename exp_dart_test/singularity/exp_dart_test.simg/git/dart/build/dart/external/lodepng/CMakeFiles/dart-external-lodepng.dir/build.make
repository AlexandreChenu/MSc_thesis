...
dart/external/lodepng/CMakeFiles/dart-external-lodepng.dir/lodepng.cpp.o: ../dart/external/lodepng/lodepng.cpp
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/git/dart/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object dart/external/lodepng/CMakeFiles/dart-external-lodepng.dir/lodepng.cpp.o"
	cd /git/dart/build/dart/external/lodepng && /usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/dart-external-lodepng.dir/lodepng.cpp.o -c /git/dart/dart/external/lodepng/lodepng.cpp
...
dart/external/lodepng/CMakeFiles/dart-external-lodepng.dir/lodepng.cpp.i: cmake_force
	...
	cd /git/dart/build/dart/external/lodepng && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /git/dart/dart/external/lodepng/lodepng.cpp > CMakeFiles/dart-external-lodepng.dir/lodepng.cpp.i
...
dart/external/lodepng/CMakeFiles/dart-external-lodepng.dir/lodepng.cpp.s: cmake_force
	...
	cd /git/dart/build/dart/external/lodepng && /usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /git/dart/dart/external/lodepng/lodepng.cpp -o CMakeFiles/dart-external-lodepng.dir/lodepng.cpp.s
...
dart/external/lodepng/libdart-external-lodepng.so.7.0.0: dart/external/lodepng/CMakeFiles/dart-external-lodepng.dir/lodepng.cpp.o
dart/external/lodepng/libdart-external-lodepng.so.7.0.0: dart/external/lodepng/CMakeFiles/dart-external-lodepng.dir/build.make
dart/external/lodepng/libdart-external-lodepng.so.7.0.0: dart/external/lodepng/CMakeFiles/dart-external-lodepng.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/git/dart/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX shared library libdart-external-lodepng.so"
	cd /git/dart/build/dart/external/lodepng && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/dart-external-lodepng.dir/link.txt --verbose=$(VERBOSE)
	cd /git/dart/build/dart/external/lodepng && $(CMAKE_COMMAND) -E cmake_symlink_library libdart-external-lodepng.so.7.0.0 libdart-external-lodepng.so.7.0 libdart-external-lodepng.so

dart/external/lodepng/libdart-external-lodepng.so.7.0: dart/external/lodepng/libdart-external-lodepng.so.7.0.0
	@$(CMAKE_COMMAND) -E touch_nocreate dart/external/lodepng/libdart-external-lodepng.so.7.0

dart/external/lodepng/libdart-external-lodepng.so: dart/external/lodepng/libdart-external-lodepng.so.7.0.0
...
dart/external/lodepng/CMakeFiles/dart-external-lodepng.dir/clean:
	cd /git/dart/build/dart/external/lodepng && $(CMAKE_COMMAND) -P CMakeFiles/dart-external-lodepng.dir/cmake_clean.cmake
...
dart/external/lodepng/CMakeFiles/dart-external-lodepng.dir/depend:
	cd /git/dart/build && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /git/dart /git/dart/dart/external/lodepng /git/dart/build /git/dart/build/dart/external/lodepng /git/dart/build/dart/external/lodepng/CMakeFiles/dart-external-lodepng.dir/DependInfo.cmake --color=$(COLOR)
