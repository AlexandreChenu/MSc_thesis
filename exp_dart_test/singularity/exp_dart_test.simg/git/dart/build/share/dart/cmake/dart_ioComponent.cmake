set("dart_io_DEPENDENCIES" dart)
set("dart_io_LIBRARIES" dart-io)

foreach(external_dep tinyxml2)
  ...
  if(NOT ${external_dep}_FOUND AND NOT ${EXTERNAL_DEP_UPPER}_FOUND)
    set_property(DIRECTORY PROPERTY DART_io_FOUND FALSE)
    if(NOT DART_FIND_QUIETLY)
      message(WARNING
        "Cannot retrieve dart-io because the dependency "
